...
if __name__=='__main__':
    ...
    flipdata= getHtml(websiteurl=flipcarturl,showbrowser=False,screenshotname='lp2')
    
    laptoptitles=[t.text() for t in flipdata.css('div[class="KzDlHZ"]')]
    laptoprating=[r.text()for r in flipdata.css('div[class="XQDdHH"]')]
    laptopprice=[p.text()for p in flipdata.css('div[class="Nx9bqj _4b5DiR"]')]
    #print(laptopprice)
